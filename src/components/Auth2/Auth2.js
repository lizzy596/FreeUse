    ...
    <Paper className={classes.paper} elevation={6}>
      <Avatar className={classes.avatar}>
        ...
        <Grid item xs={12} sm={12}>
          ...
          <Button fullWidth variant="contained" color="primary" onClick={demoLogin} className={classes.submit1} >
            Login with Demo Account
          </Button>

        
          <GoogleLogin
            clientId="996785164624-nq5nih3vdliav415jrlbjetmkmgp3mhm.apps.googleusercontent.com"
            render={(renderProps) => (
